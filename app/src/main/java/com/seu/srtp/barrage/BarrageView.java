...
public class BarrageView extends AppCompatTextView {
    ...
    public static final int TEXT_MIN = 24;
    public static final int TEXT_MAX = 50;
    //字体颜色
    ...
    protected void init() {
        ...
        windowHeight = rect.height()/5;

        //4.设置x为屏幕宽
        posX = windowWidth;
        //5.设置y为屏幕高度内内随机，需要注意的是，文字是以左下角为起始点计算坐标的，所以要加上TextSize的大小
        posY = textSize + random.nextInt(windowHeight - textSize)+100;
    }
